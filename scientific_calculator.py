...
btnClear = Button(
    ...
    bd=4,
    bg="powder blue",
    command=added_value.ClearEntry,
...
btnAllClear = Button(
    ...
    bd=4,
    bg="powder blue",
    command=added_value.allClearEntry,
...
btnMult = Button(
    ...
    bd=4,
    bg="powder blue",
    command=lambda: added_value.operation("mult"),
...
lblDisplay = Label(
    calc, text="Scientific Calculator", font=("arial", 20, "bold"), justify=CENTER
)
